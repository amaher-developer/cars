...
class Hybrid_Providers_Twitter extends Hybrid_Provider_Model_OAuth1 {
	...
	function loginBegin() {	   
		...
		//$tokens = array('oauth_token' => '207109597-MOcHhadX6m5Jv8XLLQ4MvOnV5qBZZwTgaknfwvCp', 'oauth_token_secret' => 'IDTl0qpIlfzl358R0C2wzxvzUae3id2enFSsU90qbD9Xe', 'oauth_callback_confirmed' => 'true');
        //print_r($tokens);
        //die();
    ...
    function setUserOfflineStatus($status, $user_token, $user_secret) {
        
        
		$this->token("access_token", $user_token);
		$this->token("access_token_secret", $user_secret);
