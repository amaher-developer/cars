...
function adminDelete(id, name){
	var conf = confirm('هل انت متأكد أنك تريد حذف العملية "'+name+'"؟');
	if(conf){
...
<div class="col-lg-6 noPrint">
    <a href="index.php?p=incomeAdd" class="btn btn-primary">اضافة وارد</a>
    <a href="index.php?p=expenseAdd" class="btn btn-primary">اضافة صارد</a>
</div><!--end col12--->
...
صادر
        ...
        <td align="center" class="noPrint">
            <a href="index.php?p=transactionEdit&id=<?php echo $record['id']?>"  class="btn default btn-xs black">
                تعديل</a>
        </td>
        <td align="center" class="noPrint">
