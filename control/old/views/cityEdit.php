...
<script>
  ...
  function initialize() {
    ...
    var egypt = new google.maps.LatLng(30.043938025919168,31.23588888768313);
    var mapOptions = {
        zoom: 6,
        center: egypt,
...
<form method="post" action="contents.php?page=cityEdit&id=<?php echo $default['id']?>" id="contactform">
...
<tr>
  ...
  <td><input name="latitude" id="txtLatitude" maxlength="11" type="text" class="inputField input" value="<?php echo $default['latitude']?>" Required></td>
</tr>
<tr>
  <td align="right"><b>Longitude</b></td>
  <td><input name="longitude" id="txtLongitude" maxlength="11" type="text" class="inputField input" value="<?php echo $default['longitude']?>" Required></td>
</tr>
