...
<form action="" method="post">
    ...
    <input class="input-data" name="name" type="text" value="موظف ١" placeholder="إسم الموظف"/>
    <div class="cleaner-h2"></div>
...
أتركها فارغة لعدم تغييرها
    ...
    <input class="input-data" name="phone" type="text" value="01xxxxxxxx" placeholder="التليفون"/>
    <div class="cleaner-h2"></div>

    <label>الوظيفة</label>
    <input class="input-data" name="job" type="text" value="محاسب" placeholder="الوظيفة"/>
    <div class="cleaner-h2"></div>
