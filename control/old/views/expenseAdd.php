...
<form action="" method="post">
    ...
    <input class="input-data" name="phone" type="text" value="" placeholder="التاريخ الحقيقي"/>
    <div class="cleaner-h2"></div>

    <label>التاريخ المالي (للعرض في التقارير الشهرية)</label>
    <input class="input-data" name="phone" type="text" value="" placeholder="التاريخ المالي"/>
    <div class="cleaner-h2"></div>
