...
<form method="post" action="contents.php?page=subcategoryAdd" id="contactform">
...
<tr><td><b>الأسم الأنجليزي</b></td><td><input type="text" name="name_en" value="<?php echo $default['name_en']; ?>" class="input" /></td></tr>
