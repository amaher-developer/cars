...
?>
<br />
<div align="right"><b>عدد المحافظات : </b><span id="total_record"><?php echo $total_records?></span></div>
<table width="100%" align="center" class="table_title">
<th>id</th><th>الأسم</th><th>name</th><th>تعديل</th><th>حذف</th>
...
<td><a href="contents.php?page=cityEdit&id=<?php echo $record['id']; ?>">تعديل</a></td>
