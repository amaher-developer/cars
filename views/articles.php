...
<h3 class="no-margin h3-inter h3-right"><a href="index.php?p=article&id=<?php echo $record['id']?>" ><?php echo $record['name']?></a></h3>
<div class="cleaner-h1"></div>
<p class="p-normal p-right"><?php echo trim($record['brief'])?></p>
<a href="index.php?p=article&id=<?php echo $record['id']?>" class="pull-right"><?php echo $clickHere?></a>
