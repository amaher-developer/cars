                            ...
                            <div class="dima-pricing-table  hidden-xsd">
                                ...
                                <div class="dima-pricing-col  ok-md-4 ok-xsd-6 featured-larg" data-animate="flipInY" data-delay="150">
                                    ...
                                    <div class="dima-pricing-col-info">
                                        ...
                                        <?php if(!$user){ ?>
                                        <a data-animated-link="fadeOut" class="di_white small Pill button fill  maher-free-button" id="payment_button" href="<?php echo Globals::$siteURL?>api/login.php?provider=twitter" title="سجل الآن">سجل الآن</a>
                                        <?php }else if($user['userpaymenttype'] > 1){ ?>
                                        <a data-animated-link="fadeOut" class="di_white small Pill button fill  maher-free-button maher-cursor-default"  title="تخطيت هذه المرحلة">تخطيت هذه المرحلة</a>
                                ...
                                <div class="dima-pricing-col ok-md-4 ok-xsd-6" data-animate="flipInY" data-delay="150">
                                    ...
                                    <div class="dima-pricing-col-info">
                                        ...
                                        <?php if(!$user){ ?>
                                        <a data-animated-link="fadeOut" class="di_white small Pill button fill  maher-free-button" id="payment_button" href="<?php echo Globals::$siteURL?>api/login.php?provider=twitter" title="سجل الآن">سجل الآن</a>
                                        <?php }else if($user['userpaymenttype'] == 2){ ?>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <?php if(!$user){ ?>
                                            <a data-animated-link="fadeOut" class="di_white tiny Pill button fill  maher-free-button" id="payment_button" href="<?php echo Globals::$siteURL?>api/login.php?provider=twitter" title="سجل الآن">سجل الآن</a>
                                            <?php }else if($user['userpaymenttype'] > 1){ ?>
                                            <a data-animated-link="fadeOut" class="di_white tiny Pill button fill  maher-free-button maher-cursor-default"  title="تخطيت هذه المرحلة">تخطيت هذه المرحلة</a>
                                            <?php }else if(($user['userpaymenttype'] > 0)){ ?>
    ...
    <div class="page-section-content overflow-hidden">
        <div class="container">
            ...
            <div class="main ok-md-12 ok-xsd-12" >
                ...
                <div class="clear"></div>
                <!-- Success Msg -->
                <div id="contactSuccess" class="dima-alert dima-alert-success fade in show" style="display: none;">
                ...
                <!-- Error Msg -->
                <div id="contactError" class="dima-alert dima-alert-error fade in show" style="display: none;">
                    <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <!-- Form -->
                <form  method="post" id="contacts" class="form-small form " >
                    <div class="ok-row">
                    ...
                    <a  class=" no-rounded button small fill" onclick="contact();" id="contact_icon">أرسل</a>
                </form>
            </div>
        </div>
    </div>
...
function contact(){
    ...
    if(!name || !email || !subject || !message){
       $("#contactError").show();
        ...
        $('#contact_icon').hide();
        $('<img id="loading" style="width:50px;"  src="images/loading.gif" />').insertAfter('#contact_icon');
        $.post('ajax/contact.php', {name:name, email:email, subject:subject, message:message}, function(data){
            //alert(data);
            if(data){
                $("#contactSuccess").show();
                $("#contacts").hide();
                //document.getElementById("contactSuccess").style.diplay = "block";             
            }else{
