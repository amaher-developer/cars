<!DOCTYPE html>
<!--
Programmed by: Ahmed Maher
Senior Developer at Internet Plus
Email: amaher.developer@gmail.com
N.B. This personal credit was approved by my friend and manager
-->
        ...
        <div class="all_content">
                                    ...
                                    <li class="shopping-btn sub-icon menu-item-has-children cart_wrapper">
                                        ...
                                        <ul class="sub-menu with-border product_list_widget" style="margin-right: -100px;padding-top: 0px;">
                                            ...
                                            <li>
                                                ...
                                                <a data-animated-link="fadeOut" href="activate.php?t=0" title="إلغاء الخدمة">
                                                إلغاء الخدمة
                                                </a>
                                                <?php }else{ ?>
            ...
            <div class="page-section-content overflow-hidden">
                ...
                <div class="container page-section text-center">
                    ...
                    <?php if(($_SESSION['twitterlogin'] == 2)|| ($_SESSION['twitterlogin'] == 1)){ ?>
                           <?php echo $user['username']?><br />السلام عليكم ورحمة الله وبركاته .. مرحبا بك في أذان تويتر <br />
                            ...
                            عن مدينة <?php echo $user['usercity']?> (<a  href="settings" class="maher-activatelink-color">تغيير المدينة</a>)<br />
                            ...
                            <a  class="di_white button uppercase fill large Pill"  href="payments" title="ترقية الاشتراك" >ترقية الاشتراك</a>
                            <?php } ?>
                            <?php if($user['userpaymenttype'] == 1){ ?><br />
                            <a  class="di_white button uppercase fill large Pill"  href="payments" title="اضافة مدة جديدة">اضافة مدة جديدة</a>
                            <?php } ?>
