...
$('.azancheckbox').click(function() {
    ...
    $.post('ajax/azansave.php', { azan1: azan1, azan2: azan2, azan3: azan3, azan4: azan4, azan5: azan5}, 
    function(result){
        $('#loading_update').delay(40).fadeIn(50);
        $('#loading_update').delay(500).fadeOut(50);
        toastr.success('تم التعديل بنجاح.');
                    ...
                    <div class="ok-row">
                        ...
                        <div class="post ok-md-6 ok-xsd-6  ">
                            <div class="field">
                                ...
                                <option value="<?php echo $city['id']?>" <?php if($city['id'] == 21){echo 'selected=""';}  if($user['usercityid'] == $city['id']){echo 'selected=""';} ?> ><?php echo $city['car']?></option>
                                <?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="post ok-md-12 ok-xsd-12  ">
                            ...
                            <div class="features-start small-flat opacity-zero show animated fadeInUp">
                              ...
                              <header role="banner">
                                ...
                                <div class="features-content" style="padding-top: 18px;" >
                                     <p>هل تود ظهور صورة تعبر عن الوقت والمدينة مع التغريدة؟ (متاحة في اشتراك VIP) (قريبا)</p>
                                </div>
                            </div>
                        ...
                        <div class="post ok-md-12 ok-xsd-12  ">
                            ...
                            <div class="features-start small-flat opacity-zero show animated fadeInUp">
                              ...
                              <header role="banner">
                                ...
                                <div class="features-content" style="padding-top: 18px;" >
                                     <p>التحكم في محتوى التغريدة (متاحة في اشتراك VIP)</p>
                                </div>
                            </div>
                        ...
                        <div class="post ok-md-12 ok-xsd-12">
                            <div class="field" style="padding-top: 10px;">
                                ...
                                <span id="charlimitinfo" class="charlimitinfo comment_number" style="width:auto;margin-left: 2%;float:right;"><?php if($user["userdoaatweet"] == 1){echo (60 - $tweet_lenght); }else{echo (140 - $tweet_lenght);}?></span>
                            </div>
                        </div>  
                        
                        <div class="post ok-md-4 ok-xsd-4  ">
                            <div class="field" style="padding-top: 10px;">
                            <input type="checkbox" name="doaatweet" class="doaatweet" id="doaatweet" <?php if($user["userdoaatweet"] == 1){ echo 'checked=""';} ?>  <?php if(!$user['userpaymenttype']){ ?>disabled=""<?php } ?> /> أضافة دعاء تلقائي
                            </div>
                        </div>      
                        ...
                        <div class="post ok-md-12 ok-xsd-12  ">
                            <div class="field">
                                <div id="doaasavefalse" style="display: none;">
                                    ...
                                    <p>عدد الحروف الاجمالي يتجاوز الحد الاقصى للتغريدة بمقدار <span id="errortextlimit"></span> حرفا، فضلا عن المحتوى الذي ادخلته قبل اختيار اضافة دعاء تلقائي (يتطلب 80 حرفا)</p>
                                </div>
                                </div>
                            </div>
                        </div>
